...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="google-site-verification" content="SFfuxCwn6UnANbfR_vK2JjR8cIJfMvlJhLJAwZm1Lj4" />
    <link rel="icon" type="image/png" href="img/favicon.png" />
    <title>SERVICIOS INMOBILIARIOS INTEGRALES GAZZO</title>
   <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"> 
    <META NAME="Title" content="SERVICIOS INMOBILIARIOS INTEGRALES GAZZO SA DE CV">
    <META NAME="Author" CONTENT="[http://serviciosinmobiliariosgazzo.com/]"/>
    <META name="Description" content="Venta de terrenos con facilidad de pago de hasta 30 meses sin intereses. ¡Contáctanos!"/>
     <META NAME="Keywords" CONTENT="terrenos, Venta terrenos, terrenos en venta."/>
  ...
  <body>
    ...
    <div class="fondo">
      <div class="menu">
        <nav class="pull-left">
          <ul>
            ...
            <a class="selector" data-scroll href="#SERVICIOS" aria-pressed="true">INMUEBLES</a>
      ...
      <div class="textobanner pull-right">
        <p class="uno">
          Te ayudamos a CRECER haciendo realidad tus SUEÑOS
        </p>
        <p class="dos">Servicios inmobiliarios integrales</p>
        <div class="">
            <a class="btn icon-btn btn-warning" data-scroll href="#CONTACTO" aria-pressed="true"><span class=" btn-glyphicon fas fa-sign-out-alt img-circle text-warning"></span>CONTACTANOS</a>
        </div>
      </div>
...
<section class="seccion2" id="SERVICIOS" style="background: #eceff1">
        ...
        <div class="row ">
         ...
         <div class="row brdr">
          <div class="col-sm-4 col-md-4">
            ...
            <p class="text-center txt-pifilmdrs" style="color: #000;">Invertir te da la oportunidad de multiplicar tu dinero, evitando que desaparezca en gastos innecesarios.</p>
          </div>
          <div class="col-sm-4 col-md-4">
            <h2 class="text-center tit-pifilmdrs" style="color: #000;">Inversión que trabaja por ti</h2>
            <p class="text-center txt-pifilmdrs" style="color: #000;">Mientras tú disfrutas lo que te gusta hacer, tu inmueble genera plusvalía sin necesidad de meter ni las manos.</p>
          </div>
          <div class="col-sm-4 col-md-4">
            <h2 class="text-center tit-pifilmdrs" style="color: #000;">Facilidad de compra</h2>
            <p class="text-center txt-pifilmdrs" style="color: #000;">No tienes que realizar un esfuerzo extra, tu mayor trabajo será elegir tu inmueble.</p>
          </div>
        </div>
...
<section class="container" style="padding: 5% 0% 0% 0%;">
    <div class="row">
        <div class="col-lg-5 mb-4">
            <div class="card border-warning rounded-0">
                ...
                <div class="card-body" style="padding: 3% 0%;">
...
<footer>
<p>Derechos de autor 2018 © |  SERVICIOS INMOBILIARIOS INTEGRALES GAZZO SA DE CV</p>
</footer>
